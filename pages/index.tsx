    ...
    //  Non-Essential, But Required for Analytics
      ...
      <main>
        ...
        <div className={"cv"}>
          <h3>Now</h3>
          <ul>
            <li>Head of UX and Service Design at <Link
              href="https://www.pwc.co.uk/services/consulting/the-experience-centre.html" target="blank">PwC
              UK</Link>.</li>
          </ul>
          <h3>Before</h3>
          <ul>
            <li><span className={"code smallcopy"}>Dec/19 &#8594; Oct/20 (Contract):</span><br />Lead UX Designer at
              <Link href="https://www.pwc.com/" target="blank">PwC</Link>.
            </li>
            <li><span className={"code smallcopy"}>Jul/17 &#8594; Nov/19: (Contract)</span><br />Service Design
              Manager at <Link href="https://www.lloydsbank.com/help-guidance/managing-your-money/moneyworries.html" target="blank">Lloyds Banking Group</Link>
            </li>
            <li><span className={"code smallcopy"}>Nov/16 &#8594; Jun/17: (Contract)</span><br />User Experience
              Director
              at <Link href="https://www.rapp.com/" target="blank">RAPP</Link>.</li>
          </ul>
          <h3>More</h3>
          <ul>
            <li>During my over 20 years career I've been lucky to work for some well known brands like Adidas,
              Airbnb, BP, Citibank, HP and PayPal.</li>
          </ul>
        </div>
        <div className={"contact"}>
          <p>You can find me on <Link href="https://www.linkedin.com/in/jrmediavilla/" target="blank">LinkedIn</Link> or
            <Link href="https://twitter.com/JuanMediavilla" target="blank">Twitter</Link>.
          </p>
        </div>
